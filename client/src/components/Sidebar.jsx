    ...
    text-white ${selectedUser ? "max-md:hidden" : ''}`} >
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
             <img src={assets.chatter_logo11} alt="logo" className='max-w-40' />
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
            ...
            text-white text-xs placehholder-[#c8c8c8] flex-1' placeholder='Search User...'/>
        </div>
     ...
     <div className='flex flex-col'>
         {filteredUsers.map((user, index)=>(
          ...
          ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
           ...
           className='w-[35px] aspect-[1/1] rounded-full'></img>
